...
public class Detection extends Activity implements CvCameraViewListener2 {
	...
	public Mat detection(DisplayMetrics displayMetrics, MatOfPoint3f objectPoints, MatOfPoint2f imagePoints, Mat touchedPointMatrix) throws Exception {
		...
		touchedPointMatrix.put(0, 0, 0);
		touchedPointMatrix.put(1, 0, 0);

		Point3 point3D1 = new Point3(0, 0, 0);
		Point3 point3D2 = new Point3(0, 0, 0);
		Point3 point3D3 = new Point3(0, 0, 0);
		Point3 point3D4 = new Point3(0, 0, 0);
		...
		Point point2D2 = new Point(0, 0);
		Point point2D3 = new Point(0, 0);
		Point point2D4 = new Point(0, 0);
		imagePoints = new MatOfPoint2f(point2D1, point2D2, point2D3, point2D4); // Points du robot dans le repère de la caméra

		return MatrixTransformations.detection(displayMetrics, objectPoints, imagePoints, touchedPointMatrix);
